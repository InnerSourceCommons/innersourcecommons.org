...
One approach is to just quickly react with a "I&#8217;ll look into it, I won&#8217;t get to it in the next few days though" to a <a href="https://innersourcecommons.org/learn/learning-path/trusted-committer/01"><em>Trusted Committer&#8217;s</em></a> feedback if you know that you&#8217;ll only be able to come back to them in a few days.
...
It&#8217;s best to ask a <a href="https://innersourcecommons.org/learn/learning-path/trusted-committer/01"><em>Trusted Committer</em></a> about how to best discuss your proposal.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>Here&#8217;s what you can do to make reviewing and merging as easy as possible for the the <a href="https://innersourcecommons.org/learn/learning-path/trusted-committer/01"><em>Trusted Committer</em></a> and the host team.
...
<div class="paragraph">
<p>The basic point here is to enable the <a href="https://innersourcecommons.org/learn/learning-path/trusted-committer/01"><em>Trusted Committer</em></a> to validate the contribution without your presence and to ensure easy maintainability.
...
<li>
<p>Be civil and expect civility from the <a href="https://innersourcecommons.org/learn/learning-path/trusted-committer/01"><em>Trusted Committer&#8217;s</em></a> review.</p>
</li>
</ul>
</div>
</li>
