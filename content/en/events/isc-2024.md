...
<tr>
    ...
    <td colspan="2"><b>Welcome to the Summit Day 2 & InnerSource Commons Update</b><br>
...
<!-- <td class="author"> <b></b> InnerSource pattern search workshop<br>
    </div>     
  </td> -->
  </td>
    <td class="author"> <b><a href="#Isabel_Drost_Fromm">Isabel Drost-Fromm</a></b> (Europace AG / InnerSource Commons)<br>
    InnerSource pattern search workshop (continued)
    <span onClick="toggleAbstract('Isabel_Drost_Fromm_abstract')" class="abstract-toggle">(<a id="Isabel_Drost_Fromm-link">Show Abstract</a>)</span>
      <div style="display:none" class="abstract" id="Isabel_Drost_Fromm_abstract">

We have a whole lot of patterns that teams using InnerSource can rely on. In this one hour workshop participants can bring their InnerSource challenges to the table. Together participants will select the challenge that they want to work on to find new pattern ideas, work on those and come up with.a pattern draft that will be submitted to the patterns community.
