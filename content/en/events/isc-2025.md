...
<!-- ### 🎟️ Get Your Ticket for InnerSource Summit 2025! -->
 ...
 Thursday, 13th November 2025 to celebrate 10 years of InnerSource Commons — with events happening across Yokohama 🇯🇵, Berlin 🇩🇪, New York 🇺🇸, and online 🌍!
<br />
...
Join us for a truly global celebration as we mark the 10th anniversary of InnerSource Commons with a 24-hour Summit spanning Yokohama, Berlin, and New York. Our agenda is packed with inspiring keynotes, in-person sessions, and online talks from leading InnerSourcerers around the world.

From practical case studies and success stories to deep dives into collaboration, culture, and scaling InnerSource practices, the program reflects the diversity and innovation of our community. Each regional hub will highlight local expertise and global perspectives—creating a continuous journey of learning and connection across time zones.

Whether you’re joining us in person or online, the 2025 agenda is designed to inform, inspire, and celebrate the next decade of open collaboration.
<br />
<br />
...
<table class="schedule table table-striped">
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Yuki_Hattori">Yuki Hattori / 服部 佑樹 (Mr.)</a></b><br>(InnerSource Commons)<br>
...
<tr>
  ...
  <td class="author w-70"> <b><a href="#Yusuke_Shijiki">Yusuke Shijiki / 志自岐 雄介​ (Mr.) </a></b><br>(Mitsubishi Electric)<br>
   No Innovation without Co-Creation: Mitsubishi Electric’s Transformation into an Innovative Company
...
In FY2025, Mitsubishi Electric declared its transformation into an “Innovative Company.” At the heart of this transformation lies one principle: “No innovation without co-creation.”
This strategic vision is built on three pillars:
- Business model innovation through Serendie, combining design and manufacturing expertise with on-site data to accelerate co-creation inside and outside the company
- Strengthening digital platforms, including cloud and generative AI
- Driving a broad mindset transformation across the organization

In this session, Yusuke Shijiki, Executive Officer (Associate), Vice President, Corporate Manufacturing and Engineering, will share the executive-level vision behind this transformation. Based on his strong belief in co-creation, he made the decision in 2025 to establish Mitsubishi Electric’s Open Source & InnerSource Program Office (OSPO/ISPO) as a foundation to accelerate co-creation both inside and outside the company. He will explain the background of this decision and how it reflects Mitsubishi Electric’s determination to put co-creation at the center of its innovation journey.
...
<tr>
  ...
  <td class="author w-70"> <b><a href="#Shingo_Oidate">Shingo Oidate / 追立 真吾 (Mr.)</a></a>and </a><a href="#Kazuma_Nogi">Kazuma Nogi</a></b><br>(Mitsubishi Electric)<br>
...
<tr>
  ...
  <td class="author w-70"> <b><a href="#Shane_Martin_Coughlan">Shane Martin Coughlan (Mr.)</a></b><br>(The Linux Foundation)<br>
...
Open source process management around license, security and regulatory compliance is a topic that has been growing in importance over the past decade. The emergence of process standards such as OpenChain ISO/IEC 5230 (license compliance) and OpenChain ISO/IEC 18974 (security assurance) are two direct examples, but there is an even broader spread of signifiers across the IT industry. SBOM formats like SPDX and CycloneDX. Open source tooling for open source compliance matters. Regulations like the CRA. The question is how and why this all matters to InnerSource Program Offices and other parties charged with InnerSource strategy and implementation. This talk will expand on that.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Nitish_Tyagi">Nitish Tyagi (Mr.)</a></b></a> - Virtual Session </a><br>(Gartner Inc.)<br>
...
<td class="UTC">UTC 02:50</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Zachery_Koppert">Zack Koppert (Mr.) </a></b></a> - Virtual Session </a><br>(GitHub)<br>
...
Whether you're an engineer, program lead, or executive sponsor, this talk will equip you with the tools and mindset to demystify InnerSource measurement—and use it to drive meaningful and valuable internal collaboration.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Jerry_Tan">Jerry Tan (Mr.) </a></b></a> - Virtual Session </a><br>(China OpenSource Promotion Union)<br>
...
Secondly, AI for InnerSource, where we will highlight several InnerSource processes that can be improved through AI. For example, documentation and code reviews.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Tomohiro_Nakajima">Tomohiro Nakajima / 中島 智弘 (Mr.)</a></b><br>(KDDI Agile Development Center)<br>
...
In this session, I will share the origin story of the InnerSource Hero and explore the core values I learned from the practitioner community. By retracing these steps, participants will gain practical insights into how to overcome challenges such as reinventing the wheel or working in organizational silos—and be inspired to take their own next step with InnerSource.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Chen_Wei">Chen Wei(Mr.)</a></b><br>(Huawei)<br>
   Huawei InnerSource Culture and Value Closed-Loop Practice
  <span onClick="toggleAbstract('Chen_Wei_abstract')" class="abstract-toggle">(<a id="Chen_Wei-link">Show Abstract</a>)</span>
     <div style="display:none" class="abstract" id=Chen_Wei_abstract>
...
- Product Adoption Mechanism and Quality Management of InnerSource Software
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Katsura_Ito">Katsura Ito / 伊藤かつら (Ms.)</a></b><br>(National Personnel Authority)<br>
...
The mindset and capabilities required for future-oriented engineers, and organizational frameworks for developing and leveraging these qualities. We will discuss building mutually beneficial growth relationships between engineers and organizations.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Katsura_Ito">Katsura Ito </a>and </a><a href="#Yuki_Hattori"> Yuki Hattori</a></b><br>(National Personnel Authority and InnerSource Commons)<br>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Mishari_Muqbil">Mishari Muqbil (Mr.)</a></b><br>(Zymple)<br>
...
This talk explores why metric-driven approaches often fail in open source environments and proposes a more effective alternative: using behavioral science and experience design to make good practices feel natural, rewarding, and even inevitable.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Ryo_Ashikawa">Ryo Ashikawa (Mr)</a></b><br>(NIFTY Corporation)<br>
   Three points that promoted innersource activities
  <span onClick="toggleAbstract('Ryo_Ashikawa_abstract')" class="abstract-toggle">(<a id="Ryo_Ashikawa-link">Show Abstract</a>)</span>
     <div style="display:none" class="abstract" id=Ryo_Ashikawa_abstract>
    
Since introducing Innersource in 2022, we’ve found three effective ways to boost internal collaboration:  
- Team-based efforts, especially by platform teams, attract more contributions than individual tools, aligning with Team Topologies
- Using GitHub’s GUI and clear contribution guidelines enabled even non-engineers to make direct contributions, such as editing content; 
- Hosting internal “trial contribution” workshops lowered the entry barrier and encouraged wider participation, helping to build an internal contributor community.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Younes_Hairej">Younes Hairej (Mr.)</a></b><br>(Aokumo Inc.)<br>
...
You’ll leave with a toolkit to assess your current maturity, pinpoint gaps, and communicate impact in terms that matter to decision-makers.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Yoshitake_Kobayashi">Yoshitake Kobayashi (Mr.)</a></b><br>(Toshiba)<br>
...
In this talk, I will introduce practices we applied following the InnerSource Way, the benefits observed, and the barriers faced when scaling, along with strategies to overcome them.
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Daniel_Izquierdo_Cortázar">Yuki Hattori / Daniel Izquierdo Cortázar</a></b><br>(InnerSource Commons)<br>
...
<td class="UTC">UTC 08:55</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Daniel_Izquierdo_Cortázar">Daniel Izquierdo Cortázar </a></b><br>(InnerSource Commons)<br>
...
<td class="UTC">UTC 09:05</td>
  ...
  <td class="author w-70"> <b><a href="#Peter_Giese">Peter Giese </a></b><br>(SAP)<br>
...
<td class="UTC">UTC 09:20</td>
 ...
 <tr>
   ...
   <td class="author w-70"> <b><a href="#Clare_Dillon">Clare Dillon </a></b>- Virtual Session<br>(CURIOSS)<br>
...
<td class="UTC">UTC 10:00</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Robert_Hansel">Robert Hansel </a>and </a><a href="#Benjamin_Ihrig">Benjamin Ihrig </a></b><br>(Bosch / SAP SE)<br>
...
<td class="UTC">UTC 10:30</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Ayodeji_Ogundare">Ayodeji Ogundare </a></b><br>(Adyen)<br>
...
Let me share with you how we can address this challenge. We assessed the full process for contributing to Inner Source within our company, including all requirements and necessary actions. We analyzed and measured where people spend time in the process, and then came up with suggestions for cutting the red tape and for automating compliance topics.  
Finally, for a smooth Inner Source journey, also from an individual project perspective, we need to make it as easy as possible to contribute. I’ll share some examples and suggestions here which can serve as a model for achieving this.
<td class="UTC">UTC 11:30</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Magaret_Ekerendu">Magaret Ekerendu </a></b>- Virtual Session<br>(Otaku.Hugo)<br>
...
<td class="UTC">UTC 12:00</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Gilles_Gravier">Gilles Gravier </a></b>- Virtual Session<br>(Geneva State Administration IT Services)<br>
...
<td class="UTC">UTC 12:30</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Roman_Martin">Roman Martin,<a href="#Carlos_Navarro"> Carlos Navarro </a>and </a> <a href="#Ana_Gamito">Ana Gamito </a></b><br>(Red Hat / AXA Group Operations)<br>
...
<td class="UTC">UTC 13:00</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Frédéric_Sicot_Mouret">Frédéric Sicot Mouret </a>and </a> <a href="#Nataliia_Kees">Nataliia Kees </a></b><br>(Airbus)<br>
...
<td class="UTC">UTC 13:30</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Isabel_Drost_Fromm">Isabel Drost-Fromm </a></b><br>(Europace AG)<br>
...
<td class="UTC">UTC 14:00</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Russ_Rutledge_welcome">Russ Rutledge </a>and </a></a><a href="#Daniel_Izquierdo_Cortázar">Daniel Izquierdo Cortázar</a></b><br>(InnerSource Commons)<br>
...
<td class="UTC">UTC 14:30</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Klaas-Jan_Stol">Klaas-Jan Stol </a></b>- Berlin In-person exclusive session<br>(University College Cork)<br>
...
<td class="UTC"></td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Chamindra_de_Silva">Chamindra de Silva </a>and </a> <a href="#Daniel_Izquierdo_Cortázar">Daniel Izquierdo Cortázar </a></b>- Berlin In-person exclusive session<br>(Citi)<br>
...
<td class="UTC"></td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Inez_Störzer">Inez Störzer </a>and </a> <a href="#Maximilian_Capraro">Maximilian Capraro </a></b>- Berlin In-person exclusive session<br>(DATEV eG)<br>
...
<td class="UTC">UTC 14:35</td>
 ...
 <tr>
  ...
  <td class="author w-70"> <b><a href="#Olivia_Buzek">Olivia Buzek </a></b><br>(IBM)<br>
...
<td class="author w-70"> <b><a href="#Micaela_D_Eller">Micaela D Eller </a>and </a> <a href="#Jenna_Ritten">Jenna Ritten</a></b><br>(Ernst & Young / IBM)<br>
...
<td class="UTC">UTC 15:30</td>
 ...
 <tr>
       <td class="time">11:00 - 11:30</td>
  <td class="author w-70"> <b><a href="#Christian_DeFeo">Christian DeFeo </a>and </a> <a href="#Amber_Lindsey-Rigg">Amber Lindsey-Rigg</a></b>- Virtual Session<br>(Shell)<br>
   New Open Source Tools to Enable InnerSource 
  <span onClick="toggleAbstract('Christian_DeFeo_abstract')" class="abstract-toggle">(<a id="Christian_DeFeo-link">Show Abstract</a>)</span>
    <div style="display:none" class="abstract" id=Christian_DeFeo_abstract>
...
<td class="UTC">UTC 16:00</td>
 ...
 <tr>
       <td class="time">11:30 - 12:00</td>
  <td class="author w-70"> <b><a href="#Rahul_Agarwal">Rahul Agarwal </a></b><br>(IBM)<br>
   Validating AI Outputs at Live Events
  <span onClick="toggleAbstract('Rahul_Agarwal_abstract')" class="abstract-toggle">(<a id="Rahul_Agarwal-link">Show Abstract</a>)</span>
    <div style="display:none" class="abstract" id=Rahul_Agarwal_abstract>
     
Generative AI isn't just about creating—it’s about creating accurately, safely, and reliably. At IBM iX Events, Rahul architected the LLM Judge framework, a robust validation layer that evaluates AI-generated outputs autonomously, uses Theory of mind logic to learn from human in the loop to get better. He applied this in high-stakes environments like Wimbledon, the Masters, the Grammys, and ESPN NFL Fantasy. These systems handled 1,100+ RPS, served over 500,000 users live, and spanned 280+ ML models under intense, real-time loads. In this session, Rahul will walk through how LLM Judge was designed, scaled, and adapted across domains:
- Core design principles: modular validation logic, layered checks, domain-agnostic scoring metrics.
- Domain adaptation: how we repurposed Wimbledon’s validation pipelines for golf commentary scoring, music summaries, and fantasy sport insights—all without starting from scratch.
- Reliability in action: infrastructure choices that sustained low latency and high throughput under peak event stress.
- Metrics that matter: including improving summary accuracy by 30%, reducing hallucination errors, and increasing user trust—as measured by engaged chat rates.
...
<td class="UTC">UTC 17:00</td>
 ...
 <tr>
       <td class="time">12:30 - 13:00</td>
  <td class="author w-70"> <b><a href="#Aaron_M_Kippins">Aaron M Kippins, <a href="#Michael_Gildein">Michael Gildein </a>and </a><a href="#Allison_Moshier">Allison Moshier </a></b><br>(IBM - ZTeam)<br>
   An InnerSource Transformation Story
  <span onClick="toggleAbstract('Michael_Gildein_abstract')" class="abstract-toggle">(<a id="Michael_Gildein-link">Show Abstract</a>)</span>
    <div style="display:none" class="abstract" id=Michael_Gildein_abstract>
     
Adopting InnerSource culture is transforming how productive and effective businesses can be. Embracing InnerSource has reduced internal duplication of efforts, is building a strong internal incubator for features and products, and helping model what joint customer communities could look like. Join us to discuss various lessons learned and repeatable patterns we have used for a successful InnerSource adoption. We will share successful project stories, project security considerations, and other tips.
<td class="UTC">UTC 17:30</td>
 ...
 <tr>
       <td class="time">13:00 - 13:30</td>
  <td class="author w-70"> <b><a href="#Jeff_Bailey">Jeff Bailey </a></b>- Virtual Session<br>(InnerSource Commons)<br>
...
<td class="UTC">UTC 18:00</td>
 ...
 <tr>
       <td class="time">13:30 - 14:00</td>
  <td class="author w-70"> <b><a href="#Oscar_Lobaton_Salas">Oscar Lobaton Salas </a></b>- Virtual Session <br>(Credicorp)<br>
...
<td class="UTC">UTC 18:30</td>
 ...
 <tr>
       <td class="time">14:00 - 14:30</td>
  <td class="author w-70"> <b><a href="#Katie_Schueths">Katie Schueths </a></b><br>(InnerSource Commons)<br>
...
<td class="UTC">UTC 19:00</td>
 ...
 <tr>
       <td class="time">14:30 - 15:00</td>
  <td class="author w-70"> <b><a href="#Lizzie_Salita">Lizzie Salita </a></b><br>(Booz Allen Hamilton)<br>
...
<tr>
       <td class="time">15:00 - 15:30</td>
  <td class="author w-70"> <b><a href="#Aaron_M_Kippins">Aaron M Kippins, <a href="#Michael_Gildein">Michael Gildein </a>and </a><a href="#Allison_Moshier">Allison Moshier </a></b>- Virtual Session<br>(IBM - ZTeam)<br>
   The Value of InnerSource Culture
  <span onClick="toggleAbstract('Aaron_M_Kippins_abstract')" class="abstract-toggle">(<a id="Aaron_M_Kippins-link">Show Abstract</a>)</span>
    <div style="display:none" class="abstract" id=Aaron_M_Kippins_abstract>
     
InnerSource is an incredible paradigm to follow for any organization, allowing even Fortune 500 Companies feel like a startup. For the IBM Z platform with over 60 years of custom tooling and a legendary reputation for quality to adopt a culture of InnerSource is not a simple switch. How do you encourage developers that side project culture could be valuable to the business? How do you implore your organizations leaders by taking a project from an idea to their next business decision? Join us as we discuss how we showed InnerSource’s potential value to help bolster IBM’s business.
<td class="UTC">UTC 20:00</td>
  ...
  <td class="author w-70"> <b><a href="#Lucas_Gonze">Lucas Gonze </a></b><br>(Independent Practicioner)<br>
...
<td class="UTC">UTC 20:30</td>
  ...
  <tr>
       <td class="time">16:00 - 16:30</td>
  <td class="author w-70"> <b><a href="#Trin_Baumgarten">Trin Baumgarten </a>and </a> <a href="#Caroline_T_Jones">Caroline T Jones</a></b><br>(The Aeorspace Corporation)<br>
...
<td class="UTC">UTC 21:00</td>
  ...
  <tr>
       <td class="time">16:30 - 17:00</td>
  <td class="author w-70"> <b><a href="#Micaela_D_Eller">Micaela Eller </a></b><br>(Ernst & Young)<br>
...
<div class="clearfix speaker-bio">
<img alt="Aaron M Kippins photo" src="/images/events/speakers/Summit 2025/Aaron M Kippins.png" width="200" class="speaker-photo" id="Aaron_M_Kippins" />


**Aaron M Kippins** (The Value of InnerSource Culture) (An InnerSource Transformation Story)


Aaron Kippins Senior Software Engineer - z/OS Upgrade, Installation, & Modernization Aaron Kippins is a Senior Software Engineer with nearly a decade of experience in Enterprise Computing. He currently is working on the Installation and Upgrade processes for IBM Z and is a key player in modernizing the platform. Starting his career with IBM Z’s System Test Organization. Aaron developed expertise in testing multiple components, designing and executing end-to-end solutions tests. He also built a reputation for creating extensive automation, saving hundreds of hours in testing. Aaron has been tasked with becoming a subject matter expert (SME) in InnerSource and OpenSource as they relate to IBM Z, and has been leading the InnerSource effort for IBM Z. 
</div>

<div class="clearfix speaker-bio">
<img alt="Allison_Moshier photo" src="/images/events/speakers/Summit 2025/Allison Moshier.png" width="200" class="speaker-photo" id="Allison_Moshier" />


**Allison Moshier** (The Value of InnerSource Culture) (An InnerSource Transformation Story)


 Allison Moshier is a Senior Product Manager for IBM Z & LinuxONE Security. She is responsible for emerging IBM Z & LinuxONE security stack synergies. Allison joined IBM in 2018. With most of her time spent in product management, she has successfully led numerous product launches for strategic offerings and has been responsible for executing key initiatives across the organization.
</div>
...
<div class="clearfix speaker-bio">
<img alt="Chen Wei photo" src="/images/events/speakers/Summit 2025/Chan Wei.png" width="200" class="speaker-photo" id="Chen_Wei" />


**Chen Wei** (Huawei InnerSource Culture and Value Closed-Loop Practice)


Senior Project Director of Huawei InnerSource Office. Having worked at Huawei for 15 years, he has extensive experience in project development, project management, and InnerSource promotion. At Huawei InnerSource Office, he is responsible for building the InnerSource community culture and planning and developing InnerSource infrastructure. Additionally, he takes the lead in promoting the processes and governance mechanisms for integrating Huawei's InnerSource software into commercial products, and has achieved favorable results.
</div>

<div class="clearfix speaker-bio">
<img alt="Christian DeFeo photo" src="/images/events/speakers/Summit 2025/Christian DeFeo.png" width="200" class="speaker-photo" id="Christian_DeFeo" />


**Christian DeFeo** (New Open Source Tools to Enable InnerSource )


Dr Christian DeFeo is an experienced digital professional who has been working with the internet since 1995. His experience ranges from web development management to online marketing to InnerSourcing. He has worked for element14.com (part of Premier Farnell), Elsevier, ebookers, and HSBC prior to coming to Shell.
He has a PhD in Creative Writing (University of Southampton, 2010); and was awarded his PhD in Engineering at Loughborough in 2024.
</div>
...
<div class="clearfix speaker-bio">
<img alt="Jenna Ritten photo" src="/images/events/speakers/Summit 2025/Jenna Ritten.jpg" width="200" class="speaker-photo" id="Jenna_Ritten" />
...
<div class="clearfix speaker-bio">
<img alt="Kazuma Nogi photo" src="/images/events/speakers/Summit 2025/Kazuma Nogi.png" width="200" class="speaker-photo" id="Kazuma_Nogi" />
...
<div class="clearfix speaker-bio">
<img alt="Michael Gildein photo" src="/images/events/speakers/Summit 2025/Michael Gildein.png" width="200" class="speaker-photo" id="Michael_Gildein" />


**Michael Gildein** (The Value of InnerSource Culture) (An InnerSource Transformation Story)


As Software Supply Chain Security Architect, Michael Gildein (STSM), is leading efforts to imbue security into the processes, tooling, and infrastructure used to develop, build, test, and deliver products for IBM Z Operating Systems Development. Since 2010, he has focused on bolstering the quality and security of the legendary IBM Z platform, previously holding various positions in IBM z/OS System Test. He believes both inner and open source software can foster skill growth, drive collaboration, and increase productivity. Michael is also passionate about driving innovation and knowledge sharing as an IBM Master Inventor and Marist Adjunct Instructor.
</div>
...
<div class="clearfix speaker-bio">
<img alt="Nataliia Kees photo" src="/images/events/speakers/Summit 2025/Nataliia Kees.png" width="200" class="speaker-photo" id="Nataliia_Kees" />


**Nataliia Kees** (InnerSourcing GenAI at Airbus)


Nataliia Kees is an experienced Data Scientist with a strong background in both corporate and academic settings. She is currently part of the Data Science team at Airbus in Hamburg where she leads the development of a Generative AI platform. Passionate about sharing her knowledge, she also teaches Statistics and Data Science to help people bring their skills to the next level. Her prior industry experience includes roles at software project houses developing custom AI solutions for enterprise customers.
</div>
...
<div class="clearfix speaker-bio">
<img alt="Ryo Ashikawa photo" src="/images/events/speakers/Summit 2025/Ryo Ashikawa.png" width="200" class="speaker-photo" id="Ryo_Ashikawa" />


**Ryo Ashikawa** (Three points that promoted innersource activities)


Ryo has worked as a backend engineer and scrum master until 2018, and has been an engineering manager since. He is currently interested in InnerSource and promoting its adoption in his company.
</div>
...
**Sim Daniel Kolamkanni** (A Frictionless InnerSource Journey)
...
<div class="clearfix speaker-bio">
<img alt="Yusuke Shijiki photo" src="/images/events/speakers/Summit 2025/Yusuke Shijiki.png" width="200" class="speaker-photo" id="Yusuke_Shijiki" />
