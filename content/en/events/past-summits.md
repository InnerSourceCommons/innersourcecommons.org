...
<div class="row">
    <div class="col-lg-4 col-sm-6 mb-5 event-card">
        <div class="card border-0 h-100">
            <div class="h-md-45">
                <a class="primary-link" href="https://innersourcecommons.org/events/isc-2025/">
                    <img src="/images/events/Summit2025.jpg" alt="InnerSource Summit 2025" class="card-img rounded-lg">
                </a>
                </div>
                <div class="card-body p-0 d-flex flex-column">
                <h3><a href="https://innersourcecommons.org/events/isc-2025/" class="post-title">InnerSource Summit 2025</a></h3>
                <p class="card-text event-card-text">Registrations are Now Open 13th November 2025 - online. Join us at the world’s leading gathering of InnerSource practitioners.</p>
                <div class="d-flex mt-auto flex-md-row flex-sm-column">
                    <a href="https://innersourcecommons.org/events/isc-2025/" class="btn btn-primary primary-link btn-sm mr-md-1">Open Event</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-sm-6 mb-5 event-card">
        <div class="card border-0 h-100">
            <div class="h-md-45">
                ...
                <div class="card-body p-0 d-flex flex-column">
                <h3><a href="https://innersourcecommons.org/events/isc-2024/" class="post-title">InnerSource Summit 2024</a></h3>
                ...
                <div class="d-flex mt-auto flex-md-row flex-sm-column">
                    <a href="https://innersourcecommons.org/events/isc-2024/" class="btn btn-primary primary-link btn-sm mr-md-1">Open Event</a>
                </div>
            </div>
        </div>
    </div>
