...
{{< board-member name="Addie Cobb" title="Chair" image="/images/about/Addie_Cobb.jpg" style="bg-light" >}}
Addie Cobb is a strategic communications leader with nearly 20 years of experience in AI, open source, and InnerSource. As a Communications Strategist and Executive Coach, she has successfully elevated reputations on a global scale by fostering collaboration and simplifying complexity. Addie specializes in making technical concepts accessible, driving innovation, and empowering organizations to harness InnerSource principles for enhanced software development and cross-functional collaboration. She has worked directly on the community's web presence and has been a vocal advocate for formalizing a clear, shared definition of InnerSource. Addie has spoken about InnerSource Commons at conferences across multiple regions and has supported the InnerSource Commons Summit.
{{< /board-member >}}

{{< board-member name="Micaela Eller" title="President" image="/images/about/Micaela_Eller.jpg" >}}
Micaela Eller is an Associate Director at EY, where she leads InnerSource enablement. She previously led IBM's global InnerSource and Open Innovation transformations as Global Program Delivery Lead in the InnerSource Program Office at IBM Research, following program management roles across IBM Watson and IBM Cloud. Micaela has spoken at community calls and InnerSource Summits, served on the planning committee for the 2025 Summit, and is the Summit Director for the 2026 Summit. She has been closely involved in restructuring the Foundation's election and board organization processes, and is a certified Scrum Professional, Product Owner, and Scrum Master.
{{< /board-member >}}

{{< board-member name="Shane Coughlan" title="Vice President" image="/images/about/Shane_Coughlan.jpg" style="bg-light" >}}
Shane Coughlan is Global Ambassador for OIN 2.0 at Open Invention Network, working to expand its patent non-aggression community. He previously spent eight years at the Linux Foundation as General Manager of the OpenChain Project, where he led the development of ISO/IEC 5230 and ISO/IEC 18974, the international standards for open source license compliance and security assurance. Shane founded the European Legal Network, the largest professional community for open source legal practitioners, and has served on the board and general assembly of OpenForum Europe for over a decade. He has presented at the InnerSource Summit and has spent his career building frameworks that bring organizations together across sectors.
{{< /board-member >}}
...
Aaron Williamson is the founding attorney at Williamson Legal, where he advises clients on technology transactions, software licensing, intellectual property, and open source issues, and serves as outside general counsel to open source foundations and other technology-focused nonprofits. He was previously General Counsel and Director of Governance at the Fintech Open Source Foundation (FINOS), a partner at Tor Ekeland P.C., an attorney in legal and compliance at IEEE, and senior staff counsel at the Software Freedom Law Center. Aaron has contributed to the drafting of major open source licenses and has written amicus briefs to the U.S. Supreme Court and the Federal Circuit. He holds a J.D. from the New York University School of Law and a B.S. in computer science from Taylor University.
{{< /board-member >}}

{{< board-member name="Guilherme Dellagustin" image="/images/about/Guilherme_Dellagustin.jpg" >}}
Guilherme Dellagustin is InnerSource Officer at SAP, where he drives InnerSource adoption through presentations, event organization, mentoring, and leading by example. He has been with SAP since 2010, working as a developer and senior developer on payroll solutions across Latin America and Europe before taking on the InnerSource Officer role, and has been promoting InnerSource at SAP and across the industry since 2019. Guilherme is a consistent presence in the InnerSource Program Office Working Group and an active coach and leader within the LATAM local community, and organized the European leg of the InnerSource Summit 2025.
{{< /board-member >}}

{{< board-member name="Isabel Drost-Fromm" image="/images/about/Isabel_Drost-Fromm.jpeg" style="bg-light" >}}
Isabel Drost-Fromm is Open Source Strategist at Europace AG Germany. She`s a member of the Apache Software Foundation, co-founder of Apache Mahout and mentored several incubating projects. Isabel is a founding director of the InnerSource Commons and previously served as its President. She is interested in all things FOSS, search and text mining with a decent machine learning background. True to the nature of people living in Berlin she loves having friends fly in for a brief visit - as a result she co-founded and is still one of the creative heads behind Berlin Buzzwords, a tech conference on all things search, scale and storage.
{{< /board-member >}}
...
{{< board-member name="Cristina Coffey" image="/images/about/Cristina_Coffey.jpg" >}}
Cristina Coffey is a multidisciplinary leader with a background in software development, product strategy, marketing and organizational design. Her work spans startups, foundations, and enterprise settings, where she has applied principles of InnerSource, design thinking, and open collaboration to drive meaningful change. Cristina previously supported the InnerSource Commons as Head of Operations, contributing to community engagement, governance, and cross-organizational coordination. Cristina currently brings her expertise to the technology and energy sectors, most recently as Chief Strategy Officer at EpiSensor, where she worked across product, marketing, and organizational strategy. With a foundation in software development, a Research Master’s in Engineering, and a passion for inclusive, cross-functional collaboration, she brings a human-centred approach to systems thinking and sustainable innovation.
{{< /board-member >}}
...
{{< board-member name="Jerry Tan" image="/images/about/Jerry_Tan.png" >}}
Jerry Tan is a Senior Open Source Expert and currently serves as the Executive Deputy Secretary-General of the China Open Source Promotion Union. 
He has over 20 years of open source work experience at companies such as Sun, Baidu, and Tencent. Since 2018, Jerry has been promoting the spread and adoption of InnerSource in China. He has successfully organized numerous offline InnerSource events and initiated the Chinese InnerSource community, which boasts over 50 members, including renowned Chinese enterprises such as Huawei, Tencent, and Baidu. Jerry is passionate about sharing his knowledge and contributing to the growth of the InnerSource community.
{{< /board-member >}}
