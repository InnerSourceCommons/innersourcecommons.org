...
**Isabel Drost-Fromm** (InnerSource Commons)
...
M﻿yrle Krantz is a committee member for the Apache Diversity and Inclusion initiative and a former treasurer of the Apache Software Foundation. InnerSource Commons draws inspiration from the Apache Software Foundation in terms of how we are set up and organized as a community and we are looking forward to hearing more from Myrle about The Apache Way.
</div>
