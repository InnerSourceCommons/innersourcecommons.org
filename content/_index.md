  ...
  <div class="container">
    <div class="row text-right">
      <div class="col-md-6">
        ...
        <a href="/learn" class="btn-sm btn btn-primary mt-1"><i class="ti-blackboard pr-2"></i> Learn About InnerSource</a>
      </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
          ...
          <a href="/community" class="btn btn-sm btn-primary mt-1"><i class="ti-comments pr-2"></i> Join Community</a>
        </div>
    </div>
  </div>
</section>
